...
- `A_hkex_2800_top_of_book.parquet` — 1322550 bytes, 109544 rows (expected 109544 rows) [OK]
...
- `A_hkex_2800_trades.parquet` — 135388 bytes, 9666 rows (expected 9666 rows) [OK]
...
- `B_dreamdex_weth_top_of_book.parquet` — 65681 bytes, 6988 rows (expected 6988 rows) [OK]
  - sha256: `20c0ac91bc301b636787262b12082372016e65db892278f32b20f7ddbad63916`
  - columns: instrument, ingress_ts, transaction_ts, publish_ts, seq_id, bid_price, bid_qty, ask_price, ask_qty
- `C_nasdaq_top_of_book_20_symbols.parquet` — 38234624 bytes, 3752799 rows (expected 3752799 rows) [OK]
  - sha256: `5d644bf81d2c638d27c0ce45042059a3601fa42872b070a12f2f77059c19b696`
  - columns: instrument, ingress_ts, transaction_ts, publish_ts, seq_id, bid_price, bid_qty, ask_price, ask_qty
- `D_binance_btcusdt_orderbook_incremental.parquet` — 2691390 bytes, 17994 rows (expected 17994 rows) [OK]
...
- `F_binance_ethusdt_top_of_book.parquet` — 1831658 bytes, 235270 rows (expected 235270 rows) [OK]
...
- `G_bitfinex_btcusd_trades.parquet` — 12033 bytes, 642 rows (expected 642 rows) [OK]
  - sha256: `aed426920e2dc18b4047ce4d23b2278ca3c7f08c67547b826816a0dd1ee6a4eb`
  - columns: instrument, ingress_ts, transaction_ts, publish_ts, trade_id, price, qty, side, other_data
- `H_gateio_btcusdt_perp_trades.parquet` — 114187 bytes, 9359 rows (expected 9359 rows) [OK]
  - sha256: `c0dc1b3cdb329f604876a20ba58905959bc1853051568022e1cf971b1f249340`
  - columns: instrument, ingress_ts, transaction_ts, publish_ts, trade_id, price, qty, side, other_data
- `H_gateio_btcusdt_perp_instrument_static.parquet` — 5681 bytes, 1 row (expected 1 row) [OK]
